import { EmailLink, CallLink } from "../components";
...
const Home = () => (
  <Panel title="Home">
    ...
    <Panel.Section className="mt-4" title="Racket Restringing">
      Sunshine Coast – Murray Smith – leave your racket with the staff at the the Gibsons rec centre and paper wrap your grip with your contact info.  Contact Murray to let him know that the racket is there.  He will contact you once the racket is restrung and returned to the Gibsons community center.
      mujsmith34@gmail.com - (604) 885-7438
      Evergreen (North Vancouver) - Cathy Covernton owns and manages the on-site CC Squash Pro Shop at Evergreen. She provides all of the sportswear, shoes and equipment you will need at competitive prices. Cathy also provides expert racquet stringing and will provide you with demo racquets for testing. Special orders? No problem.
      Contact Cathy:
      Email: ccsquashshop@gmail.com
      Phone: 604-787-3097
    </Panel.Section>
  </Panel>
);
